  ...
  <div class="container">
    ...
    <div class="paopao-section1">
      ...
      <div class="brand-img">
        ...
        <img
          class="ed-img"
          v-if="brand_diy1[0].fileType == 1"
          :src="brand_diy1[0].path"
          alt=""
        />
        <video
          class="ed-video"
          v-if="brand_diy1[0].fileType == 2"
          controls
          :src="brand_diy1[0].path"
        ></video>
      </div>
    ...
    <div class="paopao-section3">
      <div
        ...
        v-for="(item, index) in brand_diy3"
        :key="index"
      >
        <div class="content">
...
export default {
  async asyncData({ app }) {
    let res = await app.$api.article.diyList();
    if (res.code == 200) {
      let comUrl = "/svc";
